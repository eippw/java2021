...
public class WorldHappinessKade2 implements DataSet {
    ...
    public WorldHappinessKade2(String infn, String outfn) throws IOException {
        this.infn = infn;
        this.outfn = outfn;
        initData();
    }
    ...
    public double getCountryMeanLadder(String countryName) {
        ...
        for(int i = 0; i < tdata.length; i++){
            ...
            count++;
            ave = ndata[i][1] + ave;
            //System.out.println("Ladder Score: " + ndata[i][1]);
            }
        }
