...
import java.util.*;
public class HappinessTesterJake {
    ...
    public static void main(String[] args) throws IOException {
        ...
        WorldHappinessJake happyData = new WorldHappinessJake(in_fn, out_fn);
        ...
        */
        ...
        System.out.print("Would you like to know the happiest and least happy country based on mean ladder score (y/n): ");
        String yn = scanner.nextLine();
        if (yn.equalsIgnoreCase("y"))
            happyData.happyNahHappy();
