...
public class WorldHappinessNate2 implements DataSet {
    ...
    public WorldHappinessNate2(String infn, String outfn) throws IOException {
        this.infn = infn;
        this.outfn = outfn;
        initData();
    }
    ...
    public double getCountryMeanLadder(String countryName) {
        ...
        double ladavg = 0;
        double count = getCount(countryName);
        int startindex = getStartIndex(countryName);
        for(int i=0;i<tdata.length;i++){
            if(tdata[i][0].equals(countryName)){
                ladavg=ndata[i][1]+ladavg;
                //System.out.println(i+ "\tLadder Score: "+ndata[i][1]);
            }
            
        }
        double average=ladavg/(double)count;
        return average;
    }
    ...
    public int getStartIndex(String countryName) {
        ...
        int startindex=-1;
        for(int r=tdata.length-1;r>-1;r--){
            if(tdata[r][0].equals(countryName)){
                startindex=r;
            }
        }
        return startindex;
     ...
     public double getCountryMeanLifeExpectancy(String countryName){
        ...
        for(int i=0;i<tdata.length;i++){
            if(tdata[i][0].equals(countryName)){
                lifeavg=ndata[i][4]+lifeavg;
                //System.out.println(i+ "\tHealthy Life expectancy: "+ndata[i][4]);
            }
            
        }
        double average=lifeavg/(double)count;
        return average;
     }
     ...
     public double getCountryMeanCorruptionPerception(String countryName){
        ...
        for(int i=0;i<tdata.length;i++){
            if(tdata[i][0].equals(countryName)){
                perc=ndata[i][7]+perc;
                //System.out.println(i+ "\tPerception of corruption "+ndata[i][7]);
            }
            
        }
        double average=perc/(double)count;
        return average;
     }
